    ...
    req.body.events.forEach((event) => {
        ...
        if (event.type == "message" && event.message.type == "text"){
            ...
            if (event.message.text == "こんにちは"){
              fetch('http://api.openweathermap.org/data/2.5/weather?q=Tokyo&appid=9a4d371b6fc452d3edd2f79b142c8c18&lang=ja&units=metric').then(res => res.json()).then(json => console.log(json.weather[0].description));
